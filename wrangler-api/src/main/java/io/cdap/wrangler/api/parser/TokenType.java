...
public enum TokenType implements Serializable {
   ...
   * This type is associated with a size value in bytes, kilobytes, megabytes, gigabytes, or terabytes.
   * E.g., "10KB", "1.5MB", "2GB", "1TB"
   */
  BYTE_SIZE,

  /**
   * Represents the enumerated type for the object of type {@code TimeDuration} type.
   * This type is associated with a duration value in milliseconds, seconds, minutes, or hours.
   * E.g., "100ms", "1.5s", "2min", "1h"
   */
  TIME_DURATION
}
